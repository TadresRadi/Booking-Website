...
from .serializers import FacilitySerializer, HotelSerializer, RoomSerializer, HotelPhotoSerializer, RoomPhotoSerializer, DetailsSerializer
from .serializers import RegisterSerializer
...
class AddFacilityView(APIView):
    ...
    latest_hotel_id = None

class AddHotelView(APIView):
    def post(self, request):
        global latest_hotel_id
