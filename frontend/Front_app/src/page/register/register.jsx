...
export function Register() {
  ...
  <Row className="w-50 justify-content-center">
    <Col md={6} className="d-flex justify-content-center">
      <Card className="card-custom w-50 ">
        <Card.Body>
          ...
          <Form onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <Form.Group className="mb-3 check_box" controlId="accept_terms">
  <Form.Check 
    type="checkbox" 
    label="I agree to the terms and policies" 
    {...register("accept_terms", { required: "You must agree to the terms" })}
  />
  {errors.accept_terms && <div className="error-message">{errors.accept_terms.message}</div>}
</Form.Group>
